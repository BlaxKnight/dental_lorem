  ...
  <div class="container-sm">
    <div class="row justify-content-center align-items-center flex-column-reverse flex-lg-row">
      ...
      <div class="col col-xl-6 justify-content-center">
        <img class="w-100" style="border-radius: 60px;" src="<?php echo e(url('assets/images/dentists.jpg')); ?>" loading="lazy">
      </div>
    </div>
  </div>
</section>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/dental/resources/views/pages/about.blade.php ENDPATH**/ ?>