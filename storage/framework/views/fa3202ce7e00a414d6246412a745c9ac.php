    ...
    <div class="row justify-content-center align-items-center flex-column flex-lg-row">
      ...
      <div class="col col-lg-6 justify-content-center">
        <video class="ratio ratio-16x9" controls="controls">
          <source src="<?php echo e(url('assets/videos/COSTA RICA IN 4K 60fps HDR (ULTRA HD).mp4')); ?>" type="video/mp4"/>
        </video>
      </div>
    </div>
  </div>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 g-4">
      <div class="col">
        <div class="card h-100 rounded-bottom-5">
          <a href="#" class="border-bottom border-1 border-primary"><img src="<?php echo e(url('assets/images/orthodontist.jpg')); ?>" class="card-img-top" alt="یه چیزی" loading="lazy"></a>
      ...
      <div class="col">
        <div class="card h-100 rounded-bottom-5">
          <a href="#" class="border-bottom border-1 border-primary"><img src="<?php echo e(url('assets/images/implant.jpeg')); ?>" class="card-img-top" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body d-flex justify-content-between flex-column">
      ...
      <div class="col">
        <div class="card h-100 rounded-bottom-5">
          <a href="#" class="border-bottom border-1 border-primary"><img src="<?php echo e(url('assets/images/bleaching.png')); ?>" class="card-img-top" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body d-flex justify-content-between flex-column">
      ...
      <div class="col">
        <div class="card h-100 rounded-bottom-5">
          <a href="#" class="border-bottom border-1 border-primary"><img src="<?php echo e(url('assets/images/tooth-removal.jpg')); ?>" class="card-img-top" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body d-flex justify-content-between flex-column">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 g-4 justify-content-center">
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/brush-teeth.png')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/calling.jpg')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/teeth-whitening.jpg')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/breath.jpg')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/3-Benefits-of-Flossing.jpg')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/toothpaste.jpg')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/coke.jpg')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card border-0 h-100">
          <a href="#"><img src="<?php echo e(url('assets/images/clock.jpg')); ?>" class="border rounded-5 border-primary border-2 card-img-top zoom-in" alt="یه چیزی" loading="lazy"></a>
          <div class="card-body">
...
<section id="about" class="bg-primary-light">
  ...
  <div class="container-sm">
    <div class="row justify-content-center align-items-center flex-column-reverse flex-lg-row">
      ...
      <div class="col col-lg-6 justify-content-center">
        <img src="<?php echo e(url('assets/images/nice-man-smiling.jpg')); ?>" class="h-100 w-100" style="border-radius: 96px 0;" loading="lazy">
      </div>
    </div>
  </div>
</section>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/dental/resources/views/pages/index.blade.php ENDPATH**/ ?>